...
For more information about Ruby One please go to https://codex.wordpress.org/Twenty_Fourteen.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Ruby One in the search form and press the 'Enter' key in your keyboard.
...
Ruby One WordPress Theme, Copyright 2013-2015 WordPress.org & Automattic.com
Ruby One is Distributed under the terms of the GNU GPL
...
Ruby One Theme is derived from the Further Theme, Copyright 2013 Takashi Irie
Further Theme is distributed under the terms of the GNU GPL

Ruby One Theme bundles the following third-party resources:
